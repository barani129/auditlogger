...
import (
	...
	"github.com/barani129/auditlogger/internal/controller"
...
func main() {
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:       "efba5c3f.spark.co.nz",
	...
	if err = (&controller.AuditLoggerReconciler{
		Kind:                     "AuditLogger",
		...
		setupLog.Error(err, "unable to create controller", "controller", "AuditLogger")
		os.Exit(1)
	}
